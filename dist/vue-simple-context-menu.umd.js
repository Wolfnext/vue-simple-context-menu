  ...
  var script = {
    ...
    methods: {
      showMenu: function showMenu (event, item) {
        ...
        console.log(event);
        if ((this.menuWidth + event.x) >= window.innerWidth) {
          menu.style.left = (event.x - this.menuWidth + 2) + "px";
        } else {
          menu.style.left = (event.x - 2) + "px";
        }

        if ((this.menuHeight + event.y) >= window.innerHeight) {
          menu.style.top = (event.y - this.menuHeight + 2 - 120) + "px";
        } else {
          menu.style.top = (event.y - 2 -120) + "px";
        }
